...
<div style="display: flex; justify-content: space-between;">
    <img src="results/clean.png" alt="Clean RSI">
    <img src="results/noisy.png" alt="Noisy">
    <img src="results/adom.png" alt="Destriping result (ADOM)">
    <img src="results/errormap_clean.png" alt="error map (clean)">
    <img src="results/errormap_noisy.png" alt="error map (noisy)">
    <img src="results/errormap_adom.png" alt="error map (ADOM)">
</div>
